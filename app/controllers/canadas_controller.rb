class CanadasController < ApplicationController
  ...
  private
  def canada_params
    params.require(:canada).permit(:application_no, :first_name, :surname, :last_name, :nationality, :passport_no, :passport_expiry, :visa_category, :date_time, :application_status, :marital_status,:sponsor, :jobcat, :sponsor_name, :sponsor_Id, :sponsor_license, :sponsor_business, :sponsor_taxation)
  end
end
